...
#include "warrior_system/warrior_system.hpp"
...
CallbackReturn WarriorTopicBridgeSystem::on_init(const hardware_interface::HardwareInfo& info)
{
...
std::vector<hardware_interface::StateInterface> WarriorTopicBridgeSystem::export_state_interfaces()
{
...
std::vector<hardware_interface::CommandInterface> WarriorTopicBridgeSystem::export_command_interfaces()
{
...
hardware_interface::return_type WarriorTopicBridgeSystem::read(const rclcpp::Time& /*time*/, const rclcpp::Duration& /*period*/)
{
    if (rclcpp::ok())
    {
...
bool WarriorTopicBridgeSystem::getInterface(const std::string& name, const std::string& interface_name,
...
hardware_interface::return_type WarriorTopicBridgeSystem::write(const rclcpp::Time& /*time*/, const rclcpp::Duration& /*period*/)
{
  // To avoid spamming WarriorTopicBridgeSystem's joint command topic we check the difference between the joint states and
...
}  // end namespace warrior::system

#include "pluginlib/class_list_macros.hpp"
PLUGINLIB_EXPORT_CLASS(warrior::system::WarriorTopicBridgeSystem, hardware_interface::SystemInterface)