...
inline double steer_rad_to_motor_rotations(double steer_position_rad, const SwerveModuleConfig & cfg)
{
...
inline double motor_rotations_to_steer_rad(double motor_rotations, const SwerveModuleConfig & cfg)
{
