...
class WaypointNavigator(Node):
    def __init__(self):
        ...
        self.declare_parameter('waypoint_1_lat', 42.3639)
        self.declare_parameter('waypoint_1_lon', -83.0732)
        self.declare_parameter('waypoint_2_lat', 42.3641)
        self.declare_parameter('waypoint_2_lon', -83.0730)
        self.declare_parameter('waypoint_3_lat', 42.3643)
        self.declare_parameter('waypoint_3_lon', -83.0728)
        self.declare_parameter('waypoint_4_lat', 42.3640)
        self.declare_parameter('waypoint_4_lon', -83.0735)
    ...
    def complete_waypoint(self):
        if self.current_waypoint_idx >= len(self.waypoints_utm):
            return
        if (self.current_waypoint_idx + 1) not in self.waypoints_completed:
        ...
        if self.current_waypoint_idx < len(self.waypoints_utm) - 1:
            ...
            self.current_waypoint_idx += 1  # Move index out of range to indicate completion
