#!/usr/bin/env python3
"""
GPS Hardware Node - Interfaces with GT-U7 GPS Module
This node reads real GPS data from the GT-U7 and publishes it to ROS 2
"""
    ...
    def __init__(self):
        ...
        try:
            ...
            self.get_logger().info(
                f'GPS Hardware Node started on {self.port} at {self.baudrate} baud'
            )
    ...
    def parse_nmea_sentence(self, sentence):
        ...
        try:
            if sentence.startswith('$GPGGA') or sentence.startswith('$GNGGA'):
                ...
                self.get_logger().info(
                    f"[GPGGA] Fix Quality: {msg.gps_qual}, Satellites: {msg.num_sats}"
                )
                if msg.gps_qual and msg.gps_qual > 0:
                    ...
                    self.get_logger().warn(
                        "Waiting for GPS fix... Make sure GT-U7 has clear sky view"
                    )
